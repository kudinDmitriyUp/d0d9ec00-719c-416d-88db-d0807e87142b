...
export const metadata: Metadata = {
  title: "Grand Luxe Hotel - Premium Luxury Accommodations",
  description: "Experience unparalleled luxury at Grand Luxe Hotel. Premium rooms, world-class amenities, exceptional service in the heart of the city.",
  keywords: ["luxury hotel", "premium accommodations", "five star hotel", "city hotel", "business travel", "vacation", "spa", "fine dining"],
  openGraph: {
    title: "Grand Luxe Hotel - Premium Luxury Accommodations",
    description: "Experience unparalleled luxury at Grand Luxe Hotel. Premium rooms, world-class amenities, exceptional service in the heart of the city.",
    siteName: "Grand Luxe Hotel",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32m5rRdd38TAyU0DZCqvrl288SF/uploaded-1763325666043-k4j2qbnt.jpg",
      alt: "Grand Luxe Hotel elegant exterior architecture"
    }],
    type: "website"
  },
  twitter: {
    ...
    title: "Grand Luxe Hotel - Premium Luxury Accommodations",
    description: "Experience unparalleled luxury at Grand Luxe Hotel. Premium rooms, world-class amenities, exceptional service in the heart of the city.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32m5rRdd38TAyU0DZCqvrl288SF/uploaded-1763325666043-k4j2qbnt.jpg"]
  },
  robots: {
    index: true,
    follow: true
